...
export function BookingModal() {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={close}>
      ...
      <DialogContent className="fixed inset-4 z-50 bg-dark-900 rounded-2xl border border-dark-700 shadow-2xl overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-dark-700">
          <h2 className="text-2xl font-bold text-white">Book Implementation Consult</h2>
          <button
            onClick={close}
