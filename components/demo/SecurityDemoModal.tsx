...
import { X, Calendar, Clock, CheckCircle, AlertCircle, Loader2, Shield } from 'lucide-react'
...
export function SecurityDemoModal({ isOpen, onClose, source = 'security:demo' }: SecurityDemoModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await submitLead({
        ...
        notes: `Security Demo Request - Use Case: ${formData.useCase}, Team Size: ${formData.teamSize}, Timeline: ${formData.timeline}, Additional Notes: ${formData.notes}`,
        wants_demo: true,
        source: source,
      }, 'security_demo_request')

      setIsSuccess(true)
    } catch (err) {
      console.error('Failed to submit security demo request:', err)
              ...
              <div className="text-center space-y-6">
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-white mb-4">
                    Security Demo Request Submitted!
                  </h3>
                  <p className="text-dark-300 mb-6">
                    Thanks! We've received your security demo request and will be in touch within 24 hours to schedule your personalized security walkthrough.
                  </p>
                  <p className="text-sm text-dark-400">
                    In the meantime, feel free to explore our security resources or reach out if you have any questions.
                  </p>
                </div>
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-dark-300 text-lg">
                See how our enterprise-grade security controls protect your sensitive legal data
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Tell us about your security requirements, compliance needs, or anything else you'd like us to know..."
                  disabled={isSubmitting}
                />
              </div>
