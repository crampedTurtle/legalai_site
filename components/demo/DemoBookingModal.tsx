...
export function DemoBookingModal({ isOpen, onClose, source = 'demo:booking' }: DemoBookingModalProps) {
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-dark-300 text-lg">
                See how Sapphire Legal AI can transform your firm's legal work
              </p>
            </div>
