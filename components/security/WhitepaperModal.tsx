          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b border-dark-700">
              <h2 className="text-xl font-semibold text-white">
                {isSuccess ? 'Download Ready' : 'Download Security Whitepaper'}
              </h2>
              <button
                onClick={handleClose}
              ...
              {isSuccess ? (
                <div className="text-center">
                  ...
                  <p className="text-dark-300 mb-6">
                    Your security whitepaper is ready for download. We've also sent a copy to your email.
                  </p>
                  ...
                  <Button 
                    ...
                    asChild
                  >
                    <a href={downloadUrl || '/docs/security_whitepaper.pdf'} download>
