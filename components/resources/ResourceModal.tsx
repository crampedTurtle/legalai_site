...
export function ResourceModal({ isOpen, onClose, resource }: ResourceModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/lead/resource-download', {
        method: 'POST',
        headers: {
          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b border-dark-700">
              <h2 className="text-xl font-semibold text-white">
                {isSuccess ? 'Download Ready' : `Download ${resource.type}`}
              </h2>
              <button
                onClick={handleClose}
              ...
              {isSuccess ? (
                <div className="text-center">
                  ...
                  <p className="text-dark-300 mb-6">
                    Your {resource.type.toLowerCase()} is ready for download. We've also sent a copy to your email.
                  </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex items-start gap-3 pt-2">
                    ...
                    <label htmlFor="optIn" className="text-sm text-dark-300">
                      Send me product updates and legal AI insights
                    </label>
                  </div>
                  ...
                  <Button
                    ...
                    disabled={isSubmitting}
                  >
                    {isSubmitting ? 'Submitting...' : `Download ${resource.type}`}
                  </Button>
                </form>
              )}
            </div>
